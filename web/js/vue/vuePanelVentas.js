var vuePanelVentas = new Vue({
    ...
    methods: {
        ...
        cargarPrecios(data) {
            ...
            if (params.botonesConPrecios == "Si")
                this.botonesPrecio = true;
            else
                this.botonesPrecio = false;
        },
        ...
        mostrarInfoVisor(objListadoTeclas) {
            ...
            ipcRenderer.send('mostrar-visor', { texto: nombreArticulo, precio: precioArticulo, total: toc.getCesta().tiposIva.importe2, dependienta: toc.getCurrentTrabajador().nombre });
        },
        resetTeclado() {
            this.listadoTeclas = [
                { idBoton: 'tecla0', idArticle: -1, pos: -1, color: 1, nombreArticulo: { nombre: '', precio: '' }, esSumable: true },
...
//# sourceMappingURL=vuePanelVentas.js.map